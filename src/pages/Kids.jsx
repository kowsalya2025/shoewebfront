...
const KidsShoes = () => {
  ...
  const products = [
    {
      id: 1,
      name: "Whitby Girls White Multi Marble EVA Clog",
      brand: "Whitby",
      price: 2799,
      originalPrice: 2799,
      rating: 4.5,
    ...
    {
      id: 2,
      name: "Walkright Claudia Girls Blue Fasten Canvas",
      brand: "Walkright",
      price: 3199,
      originalPrice: 3199,
      rating: 4.3,
    ...
    {
      id: 3,
      name: "Walkright Carey Girls Pink Polka Dot Canvas",
      brand: "Walkright",
      price: 2699,
      originalPrice: 2699,
      rating: 4.7,
    ...
    {
      id: 4,
      name: "Walkright Charlotte Girls Multi T-Bar Sandal",
      brand: "Walkright",
      price: 4799,
      originalPrice: 4799,
      rating: 4.6,
      ...
      {
      id: 6,
      name: "Surprise kids Fastern Slipper",
      brand: "Walkright",
      price: 4699,
      originalPrice: 3999,
      rating: 4.1,
      ...
      {
      id: 7,
      name: "Kids Blue Easy Fastern Slipper",
      brand: "Walkright",
      price: 4799,
      originalPrice: 4799,
      rating: 4.6,
...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm p-4 mb-6">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-800">Kids Shoes</h1>
          <button
            onClick={() => setCurrentView('cart')}
