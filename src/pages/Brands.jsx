  ...
  const products = [
    {
      ...
      reviews: 108,
      colors: ['multi-color'],
      colorOptions: ['#1a1a1bff', '#65490dff','#ebebf4ff'],
    ...
    },
    {
      ...
      reviews: 105,
      colors: ['blue'],
      colorOptions: ['#1a1a1bff', '#972918ff','#ebebf4ff'],
    ...
    },
    {
      ...
      reviews: 203,
      colors: ['multi-color'],
      colorOptions: ['#65490dff','#ebebf4ff'],
...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm p-4 mb-6">
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold text-gray-800">Mens Slippers</h1>
          <button
            onClick={() => setCurrentView('cart')}
